...
export function MenuBar() {
    return (
        <div className="h-10 w-full bg-[#1e1e1e] border-b border-[#333] flex items-center justify-between px-4 fixed top-0 left-0 z-50 select-none">
            {/* Left: App Identity & Menus */}
            <div className="flex items-center gap-6">
                <div className="flex items-center gap-2">
                    <div className="w-4 h-4 rounded-sm bg-blue-500 flex items-center justify-center text-[10px] font-bold text-white">
                        L
                    </div>
                    <span className="text-xs font-bold text-gray-300 tracking-wide">Langley.aep</span>
                </div>
            ...
            <div className="absolute left-1/2 -translate-x-1/2 text-xs text-gray-500 font-mono hidden lg:block">
            ...
            <div className="flex items-center gap-4">
                <div className="flex items-center gap-3">
                    <Monitor className="w-3.5 h-3.5 text-gray-400 hover:text-white cursor-pointer" />
                    <Layout className="w-3.5 h-3.5 text-gray-400 hover:text-white cursor-pointer" />
                </div>
